            ...
            <div className="grid md:grid-cols-4 gap-4">
              <div className="space-y-2 md:col-span-1">
                ...
                <div className="border rounded max-h-56 overflow-auto text-xs divide-y relative">
                  {studentSearchLoading && <div className="absolute inset-x-0 top-0 bg-background/80 backdrop-blur text-[10px] flex items-center gap-1 px-2 py-1"><Loader2 className="w-3 h-3 animate-spin" />Searching�Ǫ</div>}
                ...
                {selectedStudent && (
                  <>
                    ...
                    <div className="flex items-center gap-3 flex-wrap pt-2">
                      ...
                      <Button type="button" variant="outline" size="sm" disabled={!selectedStudent || loadingIndivPersonalized} onClick={loadIndivPersonalized} className="h-7 px-2 text-[11px]">{loadingIndivPersonalized? 'Loading�Ǫ':'View Latest'}</Button>
                    </div>
                    {/* Table */}
