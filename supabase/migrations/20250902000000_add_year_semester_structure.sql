...
ALTER TABLE sections ADD semester_id uuid;

ALTER TABLE subjects ADD academic_year_id uuid;
ALTER TABLE subjects ADD semester_id uuid;

ALTER TABLE college_timings ADD academic_year_id uuid;
ALTER TABLE college_timings ADD semester_id uuid;
